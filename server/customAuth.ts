    ...
    html: `
      <div style="font-family:Inter,sans-serif;max-width:480px;margin:0 auto;padding:32px 24px;background:#fff;">
        <div style="text-align:center;margin-bottom:24px;">
          <img src="https://sponsorapp-k6ifqkyq.manus.space/manus-storage/sb-footer-light_472d114c.png" alt="SponsorBridge" style="height:40px;width:auto;display:inline-block;" />
        </div>
